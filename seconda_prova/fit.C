void single_fit() {
  ...
  // Esegue il fit
  I_200->Fit(fitLin_200, "R");
  I_100->Fit(fitLin_100, "R");
  ...
  double Early_200 = std::abs(fitLin_200->GetParameter(1) / fitLin_200->GetParameter(0));
  double EarlyError_200 = std::sqrt(std::pow(fitLin_200->GetParError(1) / fitLin_200->GetParameter(0), 2) +
                                    std::pow(fitLin_200->GetParError(0) * fitLin_200->GetParameter(1) / std::pow(fitLin_200->GetParameter(0), 2), 2));
  // da aggiungere termine covarianza nell'errore

  double Early_100 = std::abs(fitLin_100->GetParameter(1) / fitLin_100->GetParameter(0));
  double EarlyError_100 = std::sqrt(std::pow(fitLin_100->GetParError(1) / fitLin_100->GetParameter(0), 2) +
                                    std::pow(fitLin_100->GetParError(0) * fitLin_100->GetParameter(1) / std::pow(fitLin_100->GetParameter(0), 2), 2));
  std::cout << '\n';                          
  ...
  double ROError_200 = std::sqrt(std::pow(fitLin_200->GetParError(1) / std::pow(fitLin_200->GetParameter(1), 2), 2));

  double RO_100 = std::abs(1 / fitLin_100->GetParameter(1));
  double ROError_100 = std::sqrt(std::pow(fitLin_100->GetParError(1) / std::pow(fitLin_100->GetParameter(1), 2), 2));
  ...
  for (int i {0}; i < I_200->GetN()-10; i++) {
    ...
    double beta_i_err = beta_i * std::sqrt(std::pow(err_200 / y_200, 2) + std::pow(err_100 / y_100, 2));
